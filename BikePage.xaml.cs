...
namespace Exotic_Cars
{
    ...
    {
        public  List<Photo> bikePhotos;
        public  BikePage()
        {
            this.InitializeComponent();
            bikePhotos = PhotoManager.getBikeImage();
        }

        private void ListView_ItemClick(object sender, ItemClickEventArgs e)
        {
            var photo = (Photo)e.ClickedItem;
            bikeSelection.Text = "you have selected:  " + photo.photoTitle;
        }

        private async void bickBtnSend_Click(object sender, RoutedEventArgs e)
        {
            ...
            await FileIO.WriteTextAsync(sampleFile, bikeSelection.Text);
